thePrompt <- paste0(
  ...
  "4. Assume the individual is a well-known public figure; therefore, external records\n",
  "   may exist to confirm or refute the affiliation.\n",
  "5. All explanations should be written in English.\n\n",
  ...
  "  \"party\": \"One party from PARTIES_OF_COUNTRY.\"\n",
